...
export class I18nService {
  ...
  private readonly translations: Translations = {
    ...
    // Transport / Transport page (page-level title/subtitle declared later in file)
    'transport.pending.international.title': { en: 'Active Flight Booking', ar: 'حجز طيران قيد المعالجة' },
    'transport.pending.international': {
      en: 'You have requested a flight. It is currently pending completion.',
      ar: 'لقد طلبت رحلة طيران. جاري إكمال الحجز.'
    },
    'transport.pending.ground.title': { en: 'Active Ground Transport Booking', ar: 'حجز نقل أرضي قيد المعالجة' },
    'transport.pending.ground': {
      en: 'You have requested a ground transport. It is currently pending completion.',
      ar: 'لقد طلبت خدمة نقل أرضي. جاري إكمال الحجز.'
    },
    // Theme labels (used where a textual label might be shown)
    ...
    'dashboard.basicInfo': { en: 'Basic Information', ar: 'المعلومات الأساسية' },
    'dashboard.distance': { en: 'Distance', ar: 'المسافة' },
    'dashboard.image': { en: 'Image', ar: 'صورة' },
    'dashboard.addRoom': { en: 'Add Room', ar: 'إضافة غرفة' },
    ...
    'transport.search.departureDateTime': { en: 'Departure Date & Time', ar: 'تاريخ ووقت المغادرة' },
    'transport.search.fromPlaceholder': {
      en: 'Departure city',
      ar: 'مدينة المغادرة',
    },
    'transport.search.returnDateTime': { en: 'Return Date & Time', ar: 'تاريخ ووقت العودة' },
    ...
    // Additional Dashboard Keys for hardcoded strings
    'dashboard.sendNewsletter': { en: 'Send Newsletter', ar: 'إرسال النشرة' },
    'dashboard.completePayment': { en: 'Complete Payment', ar: 'إتمام الدفع' },
    'dashboard.totalHotels': { en: 'Total Hotels', ar: 'إجمالي الفنادق' },
    'dashboard.flights': { en: 'Flights / Ships', ar: 'الرحلات / السفن' },
    'dashboard.groundTransportLabel': { en: 'Ground Transport', ar: 'النقل البري' },
    'dashboard.confirmed': { en: 'Confirmed', ar: 'مؤكد' },
    'dashboard.pending': { en: 'Pending', ar: 'قيد الانتظار' },
    'dashboard.paid': { en: 'Paid', ar: 'مدفوع' },
    'dashboard.cancelled': { en: 'Cancelled', ar: 'ملغي' },
    'dashboard.refunded': { en: 'Refunded', ar: 'مسترد' },
    'dashboard.totalUsers': { en: 'Total Users', ar: 'إجمالي المستخدمين' },
    'dashboard.active': { en: 'Active', ar: 'نشط' },
    'dashboard.inactive': { en: 'Inactive', ar: 'غير نشط' },
    'dashboard.datesPending': { en: 'Dates pending', ar: 'التواريخ قيد الانتظار' },
    'dashboard.trip': { en: 'Trip', ar: 'رحلة' },
    'dashboard.duration': { en: 'Duration', ar: 'المدة' },
    'dashboard.stops': { en: 'Stops', ar: 'التوقفات' },
    'dashboard.direct': { en: 'Direct', ar: 'مباشر' },
    'dashboard.flightNumber': { en: 'Flight #', ar: 'رقم الرحلة' },
    'dashboard.class': { en: 'Class', ar: 'الدرجة' },
    'dashboard.economy': { en: 'Economy', ar: 'اقتصادية' },
    'dashboard.seats': { en: 'Seats', ar: 'المقاعد' },
    'dashboard.available': { en: 'available', ar: 'متاح' },
    'dashboard.type': { en: 'Type', ar: 'النوع' },
    'dashboard.price': { en: 'Price', ar: 'السعر' },
    'dashboard.na': { en: 'N/A', ar: 'غير متوفر' },
    
    // Booking Package Component Keys
    'booking.hotelRequirements': { en: 'Hotel Requirements', ar: 'متطلبات الفندق' },
    'booking.transportRequirements': { en: 'Transport Requirements', ar: 'متطلبات النقل' },
    'booking.passengerInfo': { en: 'Passenger Information', ar: 'معلومات المسافر' },
    'booking.payment': { en: 'Payment', ar: 'الدفع' },
    'booking.makkahHotel': { en: 'Makkah Hotel', ar: 'فندق مكة' },
    'booking.madinahHotel': { en: 'Madinah Hotel', ar: 'فندق المدينة' },
    'booking.selectMakkah': { en: 'Select Makkah Hotel', ar: 'اختر فندق مكة' },
    'booking.selectMadinah': { en: 'Select Madinah Hotel', ar: 'اختر فندق المدينة' },
    'booking.bookInternational': { en: 'Book International Transport', ar: 'حجز النقل الدولي' },
    'booking.bookGround': { en: 'Book Ground Transport', ar: 'حجز النقل البري' },
    'booking.international': { en: 'International', ar: 'دولي' },
    'booking.ground': { en: 'Ground', ar: 'بري' },
    'booking.completed': { en: 'Completed', ar: 'مكتمل' },
    'booking.makkahMadinah': { en: 'Makkah + Madinah', ar: 'مكة + المدينة' },
    'booking.internationalGround': { en: 'International + Ground', ar: 'دولي + بري' },
    'booking.securePayment': { en: 'Secure Payment', ar: 'دفع آمن' },
    'booking.poweredByStripe': { en: 'Powered by Stripe', ar: 'مدعوم من Stripe' },
    'booking.passengerDetails': { en: 'Passenger Details', ar: 'تفاصيل المسافر' },
    'booking.name': { en: 'Name', ar: 'الاسم' },
    'booking.priceBreakdown': { en: 'Price Breakdown', ar: 'تفاصيل السعر' },
    'booking.subtotal': { en: 'Subtotal', ar: 'المجموع الفرعي' },
    'booking.tax': { en: 'Tax', ar: 'الضريبة' },
    'booking.serviceFee': { en: 'Service Fee', ar: 'رسوم الخدمة' },
    'booking.total': { en: 'Total', ar: 'الإجمالي' },
    'booking.cardInfo': { en: 'Card Information', ar: 'معلومات البطاقة' },
    'booking.paymentSecure': { en: 'Your payment info is encrypted and secure', ar: 'معلومات الدفع مشفرة وآمنة' },
    'booking.totalPackageCost': { en: 'Total Package Cost', ar: 'إجمالي تكلفة الباقة' },
    'booking.confirmPay': { en: 'Confirm & Pay', ar: 'تأكيد والدفع' },
    'booking.processing': { en: 'Processing...', ar: 'جاري المعالجة...' },
    'booking.processingPayment': { en: 'Processing Payment...', ar: 'جاري معالجة الدفع...' },
    'booking.pay': { en: 'Pay', ar: 'ادفع' },
    'booking.cancelGoBack': { en: 'Cancel and go back', ar: 'إلغاء والعودة' },
    'booking.termsAgreement': { en: 'By confirming, you agree to our Terms of Service and Privacy Policy', ar: 'بالتأكيد، فإنك توافق على شروط الخدمة وسياسة الخصوصية' },
    'booking.stripePaymentInfo': { en: 'Secure payment via Stripe is required to confirm your booking.', ar: 'مطلوب دفع آمن عبر Stripe لتأكيد حجزك.' },
    'booking.paymentMethod': { en: 'Payment Method', ar: 'طريقة الدفع' },
    'booking.stripeCreditDebit': { en: 'Stripe (Credit / Debit Card)', ar: 'Stripe (بطاقة ائتمان / خصم)' },
    'booking.cashComingSoon': { en: 'Cash (Coming Soon)', ar: 'نقدي (قريباً)' },
    'booking.startFresh': { en: 'Start Fresh (Clear Data)', ar: 'بدء حجز جديد (مسح البيانات)' },
    
    // Common UI Labels
    'common.required': { en: 'Required', ar: 'مطلوب' },
    'common.makkah': { en: 'Makkah', ar: 'مكة' },
    'common.madinah': { en: 'Madinah', ar: 'المدينة' },
    'common.user': { en: 'User', ar: 'مستخدم' },
    'common.admin': { en: 'Admin', ar: 'مسؤول' },
    'common.hotelManager': { en: 'Hotel Manager', ar: 'مدير الفندق' },
    
    // Booking Cancellation/Confirmation Pages
    'payment.failed': { en: 'Payment Failed', ar: 'فشل الدفع' },
    'payment.failedMessage': { en: "We couldn't process your payment. Don't worry, no charges were made to your account.", ar: 'لم نتمكن من معالجة دفعتك. لا تقلق، لم يتم خصم أي مبالغ من حسابك.' },
    'payment.tryAgain': { en: 'Try Again', ar: 'حاول مرة أخرى' },
    'payment.goToDashboard': { en: 'Go to Dashboard', ar: 'الذهاب للوحة التحكم' },
    'payment.goHome': { en: 'Go Home', ar: 'العودة للرئيسية' },
    'payment.needHelp': { en: 'Need help?', ar: 'تحتاج مساعدة؟' },
    'payment.contactSupport': { en: 'Contact Support', ar: 'تواصل مع الدعم' },
    'payment.receipt': { en: 'Payment Receipt', ar: 'إيصال الدفع' },
    'payment.thankYou': { en: 'Thank you for your booking', ar: 'شكراً لحجزك' },
    'payment.generatingReceipt': { en: 'Generating Receipt...', ar: 'جاري إنشاء الإيصال...' },
    'payment.receiptNotFound': { en: 'Receipt Not Found', ar: 'الإيصال غير موجود' },
    'payment.customerDetails': { en: 'Customer Details', ar: 'تفاصيل العميل' },
    'payment.bookingReference': { en: 'Booking Reference', ar: 'رقم الحجز' },
    'payment.paymentMethod': { en: 'Payment Method', ar: 'طريقة الدفع' },
    'payment.transactionId': { en: 'Transaction ID', ar: 'رقم العملية' },
    'payment.detailedBreakdown': { en: 'Detailed Breakdown', ar: 'التفاصيل' },
    'payment.makkahHotel': { en: 'Makkah Hotel Accommodation', ar: 'إقامة فندق مكة' },
    'payment.madinahHotel': { en: 'Madinah Hotel Accommodation', ar: 'إقامة فندق المدينة' },
    'payment.internationalFlight': { en: 'International Flight', ar: 'رحلة طيران دولية' },
    'payment.groundTransport': { en: 'Ground Transportation', ar: 'النقل البري' },
    'payment.serviceFeeTax': { en: 'Service Fees & Taxes (5%)', ar: 'رسوم الخدمة والضرائب (5%)' },
    'payment.amountPaid': { en: 'Amount Paid', ar: 'المبلغ المدفوع' },
    'payment.printDownload': { en: 'Print / Download Receipt', ar: 'طباعة / تحميل الإيصال' },
    'payment.checkIn': { en: 'Check-in', ar: 'تسجيل الوصول' },
    'payment.checkOut': { en: 'Check-out', ar: 'تسجيل المغادرة' },
    'payment.departure': { en: 'Departure', ar: 'المغادرة' },
    'payment.arrival': { en: 'Arrival', ar: 'الوصول' },
    'payment.carrier': { en: 'Carrier', ar: 'الناقل' },
  };
